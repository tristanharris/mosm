...
610     GOTO 650
620     ON VB-39 GOSUB 2950,2990,3010,3050,3070,2310,2990,3070,3010,2120,3190,1470,3100
630     GOTO 650
...
1730    IF H=248 THEN LET R$="A GBEFE XPSE - 'N S I T'":GOSUB 4260
1740    RETURN
...
2680    IF H=2445 THEN LET R$="UIF HBUFT PQFQ, UIF QPPM FNQUJFT":LET F(33)=1:GOSUB 4260
2690    RETURN
