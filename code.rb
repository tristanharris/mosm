...
70      LET J$=R$+". "+"YOU ARE "+P$+RIGHT$(D$,LEN(D$)-2)+" ":m4830
80      m3330:LET J$=""
90      FOR I=1 TO G-1
100     READ O$
110     LET P$=Y$(VAL(LEFT$(O$,1))):m3350
...
390     m3330
400     FOR I=1 TO NO:READ O$:IF I<=G THEN m3350
...
840     LET R$="B USPMM TUPQT ZPV DSPTTJOH":m4260:RETURN
850     IF F(64)=1 THEN LET F(64)=0
860     IF F(51)=1 OR F(29)=1 THEN GOTO 900
870     IF F(55)=1 THEN LET F(56)=1:LET R$="GRARGS HAVE GOT YOOU!":RETURN
...
920     IF R=52 AND C(8) AND D=4 AND F(30)=0 THEN LET R$="NO POWER!":RETURN
930     IF R=41 AND D=3 AND F(31)=0 THEN LET R$="UIF CPBU JT TJOLJOH!":m4260:RETURN
940     IF R=33 AND D=1 AND F(32)=0 THEN LET R$="OGBAN'S BOAR BLOCK YOUR PATH":RETURN
...
1000    IF (R=38 OR R=37) AND F(50)=0 THEN LET R$="JU JT UPP EBSL":m4260:RETURN
1010    IF R=49 AND D=2 AND F(54)=0 THEN ET R$="MYSTERIOUS FORCES HOLD YOU BACK":RETURN
1020    IF R=49 AND D=3 AND F(68)=0 THEN LET R$="YOU MEET OGBAN!!!":LET F(56)=1:RETURN
1030    IF R=38 ANF F(65)=0 THEN LET R$="RATS NIBBLE YOUR ANKLES":RETURN
...
1200    IF F(39)>5 AND F(29)=1 THEN LET R$="CPPUT IBWF XPSO PVU":m4260: LET F(29)=0:LET C(3)=81
1210    RETURN
1220    m3330:LET R$="OK":LET F(49)=0
1230    PRINT "YOU HAVE ";
1240    FOR I=1 TO G:READ O$:m3350:IF I=1 AND C(1)=0 AND F(44)=1 THEN LET O$="COIN"
...
1340    NEXT I:IF CO>13 THEN LET R$="YOU CANNOT CARRY ANYMORE":RETURN
...
1530    IF B=20 THEN LET R$="NBUDIFT JO QPDLFU":m4260:LET C(26)=0
1540    IF H=1648 THEN LET R$="THEREARE SOME LETTERS '"+G$(2)"'"
1550    IF H=7432 THEN LET R$="UIFZ BSF BQQMF USFFT":m4260:LET F(5)=0
...
1600    IF (H=1443 OR H=1485) AND F(33)=0 THEN LET R$="B HMJNNFSJOH GSPN UIF EFQUIT":m4260
...
1630    IF B=9 THEN LET R$="UIF MBCFM SFBET 'QPJTPO'":m4260
1640    IF H=4055 THEN m3290
1650    IF H=2969 AND F(49)=1 THEN LET R$="VERY UGLY!"
...
1730    IF H=248 THEN LET R$="A GBEFE XPSE - 'N S I T'":m4260
1740    RETURN
end
...
1830    IF (H=2228 AND C(5)=81) OR H=225 THEN LET R$=XB$+"NORTH":LET R=12
1840    IF (H=1228 AND C(5)=81) OR H=125 THEN LET R$=XB$+"SOUTH":LET R=12
1850    IF R=7 OR R=33 THEN LET R$="HE EATS IT!":C(B)=81
...
1970    RETURN
1980    IF B=3 THEN LET F(29)=1:LET R$="ZPV BSF JOWJTJCMF":LET F(55)=0:m4260
1990    IF B=20 THEN LET F(51)=1:LET R$="ZPV BSF EJTHVJTFE":LET F(55)=0:m4260
2000    RETURN
...
2140    IF H=416 THEN LET R$="ZPV IBWF LFQU BGMPBU":LET F(31)=1:m4260:RETURN
...
2340    IF (B=23 OR H=6970) AND C(26)<>0 THEN LET R$="OP NBUDIFT":m4260
...
2430    LET R$="OK":F(34)=1
2440    RETURN
end

def m2450
2450    IF B=22 AND F(37)=1 AND F(34)=1 THEN LET R$=X2$:LET F(38)=1:m4260
2460    RETURN
end
...
2680    IF H=2445 THEN LET R$="UIF HBUFT PQFQ, UIF QPPM FNQUJFT":LET F(33)=1:m4260
2690    RETURN
...
2850    IF H=3317 THEN LET R$="ZPV DBVHIU UIF CPBS":LET F(32)=1:m4260
2860    RETURN
end

def m2870
2870    IF B=10 THEN LET R$+"B OJDF UVOF":m4260
...
3040    LET R$="ZPV IBWF NJTUSFBUFE UIF CFMM!":LET F(56)=1:m4260:RETURN
3050    IF H=5861 THEN LET H=5818:m2470
3060    RETURN
end

def m3070
3070    IF (H=4864 OR H=4819) AND C(19)=0 THEN LET R$=X6$:LET F(63)=1:m4260
...
def m3260
3260    PRINT:LET R$="XIBU JT UIF DPEF":m4260:PRINT R$:INPUT CN
...
3450    LET X6$="XV SFGMFDUFE UIF XJABSET HMSBF! IF JT EFBE"
...
4360    PRINT:PRINT W$:LET J$=RIGHT$(J$+RIGHT$(W$,1),8)
...
def m4640
4640    PRINT:PRINT "PLEASE ENTER A FILE NAME":INPUT FL$
4650    RETURN
end
